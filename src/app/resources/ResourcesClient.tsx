...
const resources = [
  {
    ...
    description:
      "Most businesses waste money on ads before fixing the fundamentals. This guide walks you through the 10 digital essentials every business needs first — from brand identity and website to analytics, lead capture, and a pitch deck.",
    includes: [
  ...
  },
  {
    ...
    title: "How to Validate Your Business or Startup Idea",
    subtitle: "Stop Guessing. Start Testing. Before You Build.",
    description:
      "Most failed startups had a passionate founder who skipped validation. This step-by-step framework helps you prove whether your idea is worth building — before spending months and thousands on something nobody wants.",
    includes: [
      "The 5 Questions Every Idea Must Answer",

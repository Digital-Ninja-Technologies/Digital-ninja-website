...
export const metadata: Metadata = {
  ...
  description:
    "Digital Ninja Technologies is a global design and software development agency. We build websites, mobile apps, custom software, and games for startups, SMEs, and enterprises worldwide. No hidden fees. No disappearing acts.",
  keywords: [
    "digital agency",
    "web design agency",

...
const projects = [
  ...
  },
  {
    ...
    overview: {
      ...
      features: {
        mockupImage1: "/prayerguide-1.png",
      ...
      outcome: {
        ...
        points: [
          ...
          "1,000+ people praying daily within the first weeks of launch",
        "4.9 average rating across both stores",
        "Every feature free — no ads, no subscription",
        "2 stores live at launch from one shared design system",
        ],
      },
      gallery: [
        "/prayerguide-1.png",
